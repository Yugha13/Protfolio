...
const Works = () => {
  ...
  return (
    <div id="work">
      ...
      <div className="mt-20 flex flex-wrap gap-7 justify-stretch">
        {projects.map((project, index) => (
          <ProjectCard
            key={`project-${index}`}
            index={index}
            {...project}
            onClick={() => handleCardClick(project)} // Pass project data to handleCardClick
          />
        ))}
      </div>
      ...
      {selectedProject && (
        <div className="mt-10 w-full flex flex-col items-center">
          ...
          <button
            onClick={() => setSelectedProject(null)} // Reset selected project to close the video
